...
@ccclass('CustomStar')
export default class CustomStar extends ViewBase {
    ...
    updateAnimation(id: string) {
        ...
        if (id == this._id && this._showAnimation == true) return;
        this.reset();
    ...
    reset() {
        this.node.children.forEach(child => {
            Tween.stopAllByTarget(child.getComponent(UIOpacity));
     ...
     * 请勿修改，脚本自动生成
    */
    public static readonly VIEW_NAME = 'CustomStar';
    /**
     * 当前界面的所属的bundle名字
     * 请勿修改，脚本自动生成
    */
    ...
    */
    public get bundleName() {
        return CustomStar.BUNDLE_NAME;
    }
    public get viewName() {
        return CustomStar.VIEW_NAME;
    }
