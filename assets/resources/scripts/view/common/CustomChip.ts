...
export default class CustomChip extends ViewBase {
    ...
    buildUi() {
        ...
        this._chipButtons.forEach((num, idx) => {
            ...
            button.getComponentInChildren(cc.Sprite).spriteFrame = this.getSpriteFrame("textures/common/chip/AB_Img_" + (22 + idx) + "/spriteFrame");
            button.name = idx + '';
            button.active = false;
    ...
    setTargetChip() {
        ...
        this.buttonclick.getComponentInChildren(cc.Sprite).spriteFrame = this.getSpriteFrame("textures/common/chip/AB_Img_" + (22 + idx) + "/spriteFrame");
    }
