...
@ccclass('CustomButtomUserBets')
export default class CustomButtomUserBets extends ViewBase {
     ...
     * 请勿修改，脚本自动生成
    */
    public static readonly VIEW_NAME = 'CustomButtomUserBets';
    /**
     * 当前界面的所属的bundle名字
     * 请勿修改，脚本自动生成
    */
    ...
    */
    public get bundleName() {
        return CustomButtomUserBets.BUNDLE_NAME;
    }
    public get viewName() {
        return CustomButtomUserBets.VIEW_NAME;
    }
