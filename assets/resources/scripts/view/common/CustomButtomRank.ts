...
@ccclass('CustomButtomRank')
export default class CustomButtomRank extends ViewBase {
    ...
    buildUi() {
        ...
        this.tabGroup.iconSpriteFrames = [
            null,
            this.getSpriteFrame("textures/common/buttom/7up_Img_27"),
        ];
   ...
   protected tabGroup: GButtonGroup    = null;
     ...
     * 请勿修改，脚本自动生成
    */
   public static readonly VIEW_NAME    = 'CustomButtomRank';
    /**
     * 当前界面的所属的bundle名字
     * 请勿修改，脚本自动生成
    */
   ...
   public get bundleName() {
        return CustomButtomRank.BUNDLE_NAME;
    }
   public get viewName(){
        return CustomButtomRank.VIEW_NAME;
    }
