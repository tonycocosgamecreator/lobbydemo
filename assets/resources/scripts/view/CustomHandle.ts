...
export default class CustomHandle extends ViewBase {
    ...
    buildUi() {
        ...
        this.buttonAgail.spriteFramesOfIconWithSelected = [this.getSpriteFrame('textures/button/7up_Img_37'), this.getSpriteFrame('textures/button/7up_Img_37'), this.getSpriteFrame('textures/button/7up_Img_33')];
        this.buttonUndo.spriteFramesOfIconWithSelected = [this.getSpriteFrame('textures/button/7up_Img_38'), this.getSpriteFrame('textures/button/7up_Img_38'), this.getSpriteFrame('textures/button/7up_Img_34')];
        this.buttonClear.spriteFramesOfIconWithSelected = [this.getSpriteFrame('textures/button/7up_Img_39'), this.getSpriteFrame('textures/button/7up_Img_39'), this.getSpriteFrame('textures/button/7up_Img_35')];
