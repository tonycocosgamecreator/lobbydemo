...
@ccclass('CustomUserIcon')
export default class CustomUserIcon extends ViewBase {
    ...
    _currentData: number[] = [];
    _stage = -1;
    _positions: Vec3[] = [new Vec3(17, 0, 0), new Vec3(0, 0, 1), new Vec3(-21, 0, 2)];
    _scale: Vec3[] = [new Vec3(0.4, 0.4, 0.4), new Vec3(0.5, 0.5, 0.5), new Vec3(0.6, 0.6, 0.6)];
    ...
    animateDataUpdate() {
        ...
        cc.tween(head2)
            ...
            .start();
        // 位置3从右侧滑入
        head1.setPosition(new Vec3(27, 0, 0)); // 从更右侧开始
        opacity1.opacity = 0;
        head1.active = true;
    ...
    showHead(headNode: Node, position: Vec3, scale: Vec3) {
     ...
     * 请勿修改，脚本自动生成
    */
    public static readonly VIEW_NAME = 'CustomUserIcon';
    /**
     * 当前界面的所属的bundle名字
     * 请勿修改，脚本自动生成
    */
    ...
    */
    public get bundleName() {
        return CustomUserIcon.BUNDLE_NAME;
    }
    public get viewName() {
        return CustomUserIcon.VIEW_NAME;
    }
