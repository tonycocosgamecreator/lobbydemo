...
resourcesDb.PANEL_RESOURCES_STATISTICAL_DB_VIEWNAME = {
    ...
    'CustomDeskAnimationItem': 'CustomDeskAnimationItem',
    'CustomDeskAnimation': 'CustomDeskAnimation',
    'CustomDeskInfoItem': 'CustomDeskInfoItem',
    'CustomDeskInfo': 'CustomDeskInfo',
    'CustomDeskScoreIem': 'CustomDeskScoreIem',
    'CustomDeskScoreItem': 'CustomDeskScoreItem',
    'CustomDeskScore': 'CustomDeskScore',
    'CustomDeskStar': 'CustomDeskStar',
    'CustomFlyChip': 'CustomFlyChip',
    'CustomLuckRankUser': 'CustomLuckRankUser',
    'CustomMainHistory': 'CustomMainHistory',
    'CustomOnline': 'CustomOnline',
    'PanelGameButtom': 'PanelGameButtom',
    'PanelGameInit': 'PanelGameInit',
    'PanelGameMain': 'PanelGameMain',
}
