export namespace supersevenbaccarat{

    export const PACKAGE_NAME = 'baccarat';

    /** ID */
    export enum BaccaratID{
        /**  水果 */
        Bct_Fruit = 100,
        /**  龙虎 */
        Bct_LongHu = 101,
    ...
    export enum WinGoLotteryBetZone{
        /**  */
        Type0 = 0,
        /**  */
        Type1 = 1,
    ...
    export enum Message {
        ...
        /** spin请求消息 */
        MsgGameSpinReq = 'MsgGameSpinReq',
        /** spin回复消息 */
        MsgGameSpinAck = 'MsgGameSpinAck',
        /** 转轴数据 */
        SpinInfo = 'SpinInfo',
        /** 单条线奖励数据 */
        SloAwardItemInfo = 'SloAwardItemInfo',
        /** 投注数据 */
        BetConfig = 'BetConfig',
        /** 游戏玩家结构 */
    ...
    /** 选择区域  0-9 为选择号码   10:绿色  11:紫色   12：红色 13 大 14 小 */
    export interface MsgDealCardNft{
        /**  开奖位置ID */
        pos? : number;
        /**  开奖牌 */
        card? : AbCard;
    ...
    /** 选择区域  0-9 为选择号码   10:绿色  11:紫色   12：红色 13 大 14 小 */
    export interface WinGoOpenInfo{
        /**  */
        period? : string;
        /**  */
        pos? : number;
    ...
    /** Rocket3DInfo 3d小火箭配置信息 */
    export interface LongHuOpenInfo{
        /**  */
        period? : string;
        /**  */
        pos? : number;
    ...
    /** Rocket3DInfo 3d小火箭配置信息 */
    export interface SevenUpDownInfo{
        /** 下注区域赔率 */
        odds : string[];
        /**  停止下注秒数 */
        end_sec? : number;
    ...
    /** Rocket3DInfo 3d小火箭配置信息 */
    export interface SevenUpDownOpenInfo{
        /**  */
        period? : string;
        /**  */
        win_type? : number;
    ...
    /** CashOutPlayer 下车玩家 */
    export interface CashOutPlayer{
        /**  昵称 */
        name? : string;
        /**  玩家ID */
        player_id? : number;
    ...
    /** EnterBaccaratReq 进入百人场请求 */
    export interface MsgEnterBaccaratReq{
        /**  主题ID */
        theme_id? : number;
        /**  是否是换桌 */
        change? : boolean;
    ...
    /** EnterBaccaratRsp 进入百人场请求响应 */
    export interface MsgEnterBaccaratRsp{
        /**  请求结果信息 */
    ...
    /** LeaveBaccaratReq 离开百人场请求 */
    export interface MsgLeaveBaccaratReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** LeaveBaccaratRsp 离开百人场请求响应 */
    export interface MsgLeaveBaccaratRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
    }

    /** BetBaccaratReq 百人场下注请求 */
    export interface MsgBetBaccaratReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** BetBaccaratRsp 百人场下注请求响应 */
    export interface MsgBetBaccaratRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  扣除金币 */
        cost_coin? : string;
    ...
    /** BetBaccaratCancelReq 百人场下注取消请求 */
    export interface MsgBetBaccaratCancelReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** BetBaccaratCancelRsp 百人场下注取消请求响应 */
    export interface MsgBetBaccaratCancelRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  主题ID */
        theme_id? : number;
    ...
    /** GetBaccaratPlayerListReq 获取百人场玩家请求 */
    export interface MsgGetBaccaratPlayerListReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** GetBaccaratPlayerListRsp 获取百人场玩家请求响应 */
    export interface MsgGetBaccaratPlayerListRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  玩家列表 */
        players : PlayerInfo[];
    ...
    /** PauseBaccaratReq 暂停百人场请求 */
    export interface MsgPauseBaccaratReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** PauseBaccaratRsp 暂停百人场请求响应 */
    export interface MsgPauseBaccaratRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
    }
    ...
    /** BaccaratNextStageNtf 阶段变化通知消息 */
    export interface MsgBaccaratNextStageNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** BaccaratSettleNtf 结算通知消息 */
    export interface MsgBaccaratSettleNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** BaccaratOnlineNtf 在线人数变化通知消息 */
    export interface MsgBaccaratOnlineNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** BaccaratAreaUserBetsNtf 每个区域用户下注累计值 */
    export interface MsgBaccaratAreaUserBetsNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** BaccaratAreaUserBetsNtf 每个区域用户下注累计值 */
    export interface AreaUserBetsNum{
        /**  位置ID */
        pos_id? : number;
        /**  下注人数 */
        user_sum? : number;
    ...
    /** MyWinDataShort 我的赢奖数据 */
    export interface MyWinDataShort{
        /**  我赢的金币数 */
        win_coin? : string;
        /**  我的最新金币余额 */
        new_coin? : string;
    ...
    /** BaccaratKickOutNtf 长时间未下注踢出通知消息 */
    export interface MsgBaccaratKickOutNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** BaccaratLongHuSettleNtf LH结算通知消息 */
    export interface MsgBaccaratLongHuSettleNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** BaccaratRedBlackSettleNtf HH结算通知消息 */
    export interface MsgBaccaratRedBlackSettleNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** RocketCashOutReq 小飞机下车请求 */
    export interface MsgRocketCashOutReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** RocketCashOutRsp 小火箭下车请求响应 */
    export interface MsgRocketCashOutRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /** 下车那次下注 */
        bet_id? : number;
    ...
    /** RocketSettleNtf 小飞机爆炸结算通知消息 */
    export interface MsgRocketSettleNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** RocketFlyNtf 小火箭 起飞通知消息 */
    export interface MsgRocketFlyNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** RocketCashOutNtf 小火箭下车通知消息 */
    export interface MsgRocketCashOutNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 小火箭进度通知 */
    export interface MsgRocketRateNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 玩家取消自动下车请求 */
    export interface MsgRocketAutoCashOutReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 玩家取消自动下车请求返回 */
    export interface MsgRocketAutoCashOutRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  主题ID */
        theme_id? : number;
    ...
    /** 小火箭下注记录列表请求 */
    export interface MsgRocketPlayerHistoryReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 小火箭下注记录列表返回 */
    export interface MsgRocketPlayerHistoryRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  */
        page_count? : number;
    ...
    /** 小火箭下注记录列表返回 */
    export interface RocketPlayerHistory{
        /**  期数 */
        period? : string;
        /** 时间 */
        save_time? : number;
    ...
    /** 小火箭验证消息请求 */
    export interface MsgRocketEncryptedDataReq{
        /**  主题ID */
        theme_id? : number;
        /**  期数 */
        period? : string;
    ...
    /** 小火箭验证消息返回 */
    export interface MsgRocketEncryptedDataRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  */
        period? : string;
    ...
    /** 小火箭对局历史列表请求 */
    export interface MsgRocketDeskHistoryReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 小火箭对局历史列表请求 */
    export interface RocketDeskRate{
        /**  */
        period? : string;
        /** 时间 */
        save_time? : number;
    ...
    /** 小火箭对局历史列表返回 */
    export interface MsgRocketDeskHistoryRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  主题ID */
        theme_id? : number;
    ...
    /** //////////////////////////// winGoLottery私有协议  ///////////////////// */
    export interface MsgLotteryPlayerHistoryReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 玩家下注信息 */
    export interface MsgLotteryPlayerHistoryRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  历史下注 */
    ...
    /** 玩家下注信息 */
    export interface LotteryPlayerHistory{
        /**  期数 */
        period? : string;
        /**  下注位置id */
        select? : number;
    ...
    /** 玩家下注信息 */
    export interface MsgLotteryEncryptedDataReq{
        /**  主题ID */
        theme_id? : number;
        /**  期数 */
        period? : string;
    ...
    /** 玩家下注信息 */
    export interface MsgLotteryEncryptedDataRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  */
        period? : string;
    ...
    /** LotterySettleNtf 结算通知消息 */
    export interface MsgLotterySettleNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** LotteryOpenData 开奖数据 */
    export interface LotteryOpenData{
        /**  位置ID */
        pos_id? : number;
        /**  赢倍数 */
        win_times? : string;
    ...
    /** //////////////////////////// 5d   ///////////////////// */
    export interface MsgLotteryHistoryReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** //////////////////////////// 5d   ///////////////////// */
    export interface MsgLotteryHistoryRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  历史开奖 */
    ...
    /** //////////////////////////// 5d   ///////////////////// */
    export interface MsgEncryptedDataReq{
        /**  主题ID */
        theme_id? : number;
        /**  期数 */
        period? : string;
    ...
    /** //////////////////////////// 5d   ///////////////////// */
    export interface MsgEncryptedDataRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  */
        period? : string;
    ...
    /** Rocket3DCashOutReq 小飞机下车请求 */
    export interface MsgRocket3DCashOutReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** Rocket3DCashOutRsp 小火箭下车请求响应 */
    export interface MsgRocket3DCashOutRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /** 下车那次下注 */
        bet_id? : number;
    ...
    /** Rocket3DSettleNtf 小飞机爆炸结算通知消息 */
    export interface MsgRocket3DSettleNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** Rocket3DFlyNtf 小火箭 起飞通知消息 */
    export interface MsgRocket3DFlyNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** Rocket3DCashOutNtf 小火箭下车通知消息 */
    export interface MsgRocket3DCashOutNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 小火箭进度通知 */
    export interface MsgRocket3DRateNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 玩家取消自动下车请求 */
    export interface MsgRocket3DAutoCashOutReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 玩家取消自动下车请求返回 */
    export interface MsgRocket3DAutoCashOutRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  主题ID */
        theme_id? : number;
    ...
    /** 小火箭下注记录列表请求 */
    export interface MsgRocket3DPlayerHistoryReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 小火箭下注记录列表返回 */
    export interface MsgRocket3DPlayerHistoryRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  */
        page_count? : number;
    ...
    /** 小火箭下注记录列表返回 */
    export interface MsgRocket3DData{
        /**  */
        bet_id? : number;
        /**  */
        bet_coin? : string;
    ...
    /** 小火箭下注记录列表返回 */
    export interface MsgRocket3DPlayerHistory{
        /**  期数 */
        period? : string;
        /** 时间 */
        save_time? : number;
    ...
    /** 小火箭验证消息请求 */
    export interface MsgRocket3DEncryptedDataReq{
        /**  主题ID */
        theme_id? : number;
        /**  期数 */
        period? : string;
    ...
    /** 小火箭验证消息返回 */
    export interface MsgRocket3DEncryptedDataRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  */
        period? : string;
    ...
    /** 小火箭对局历史列表请求 */
    export interface MsgRocket3DDeskHistoryReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 小火箭对局历史列表请求 */
    export interface MsgRocket3DDeskRate{
        /**  */
        period? : string;
        /** 时间 */
        save_time? : number;
    ...
    /** 小火箭对局历史列表返回 */
    export interface MsgRocket3DDeskHistoryRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  主题ID */
        theme_id? : number;
    ...
    /** 小火箭对局历史列表返回 */
    export interface MsgRocket3DPlayer{
        /**  昵称 */
        name? : string;
        /**  玩家ID */
        player_id? : number;
    ...
    /** 小火箭本局下注玩家列表查看请求 */
    export interface MsgRocket3DDeskBetsHistoryReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 小火箭本局下注玩家列表查看请求 */
    export interface MsgRocket3DDeskBetsHistoryRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  主题ID */
        theme_id? : number;
    ...
    /** LongHuSettleNtf 结算通知消息 */
    export interface MsgLongHuSettleNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** SelfWinData 我的赢奖数据 */
    export interface MsgLongHuWinData{
        /**  我赢的金币数 */
        win_coin? : string;
        /**  我的最新金币余额 */
        new_coin? : string;
    ...
    /** LongHuShuffleCardsNtf 洗牌消息 */
    export interface MsgLongHuShuffleCardsNtf{
        /**  我赢的金币数 */
        card_num? : number;
    }

    /** LotteryOpenData 开奖数据 */
    export interface MsgLongHuOpenData{
        /**  位置ID */
        pos_id? : number;
        /**  赢倍数 */
        win_times? : string;
    ...
    /** } */
    export interface MsgLongHuPlayerHistoryReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 玩家下注信息 */
    export interface MsgLongHuPlayerHistoryRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  历史下注 */
    ...
    /** 玩家下注信息 */
    export interface MsgLongHuPlayerHistory{
        /**  期数 */
        period? : string;
        /**  下注区域 */
        bet_area? : number;
    ...
    /** 玩家下注信息 */
    export interface MsgStockPlayerHistoryReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 玩家下注信息 */
    export interface MsgStockPlayerHistoryRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  历史下注 */
    ...
    /** 玩家下注信息 */
    export interface MsgStockPlayerHistory{
        /**  期数 */
        period? : string;
        /**  下注位置id */
        bet_id? : number;
    ...
    /** 公平性验证 */
    export interface MsgStockEncryptedDataReq{
        /**  主题ID */
        theme_id? : number;
        /**  期数 */
        period? : string;
    ...
    /** 公平性验证 */
    export interface MsgStockEncryptedDataRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  */
        period? : string;
    ...
    /** StockSettleNtf 结算通知消息 */
    export interface MsgStockSettleNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** StockSettleData 结算数据 */
    export interface MsgStockSettleData{
        /**  位置ID */
        bet_pos? : number;
        /**  赢金币数 */
        win_coin? : string;
    ...
    /** StockWinData 胜利者数据 */
    export interface MsgStockWinData{
        /**  赢金币数 */
        name? : string;
        /**  赢金币数 */
        win_coin? : string;
    ...
    /** 股票历史列表请求 */
    export interface MsgStockDeskHistoryReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 股票历史列表请求 */
    export interface MsgStockDeskHistory{
        /**  */
        period? : string;
        /** 股票曲线点位 */
        stock_info? : StockInfo;
    ...
    /** 股票历史列表请求 */
    export interface MsgStockDeskHistoryRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  主题ID */
        theme_id? : number;
    ...
    /** SelfWinData 我的赢奖数据 */
    export interface MsgSevenUpDownWinData{
        /**  我赢的金币数 */
        win_coin? : string;
        /**  我的最新金币余额 */
        new_coin? : string;
    ...
    /** spin请求消息 */
    export interface MsgGameSpinReq{
        /** 币种 */
        currency : string;
        /** 底注列表 */
        bet_size? : number;
    ...
    /** spin回复消息 */
    export interface MsgGameSpinAck{
        /** 错误码 */
        code? : number;
        /** 交易订单号 */
        sn? : string;
...
window['supersevenbaccarat'] = supersevenbaccarat;
