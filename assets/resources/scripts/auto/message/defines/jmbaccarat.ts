export namespace jmbaccarat{
    ...
    /** MsgRecordDetailReq 请求游戏的历史记录 */
    export interface MsgRecordDetailReq{
        /**  */
        desk_id? : number;
    }
