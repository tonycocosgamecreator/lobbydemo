export namespace gate{
    ...
    export const PACKAGE_NAME = 'gate';
    ...
    /** GateAuthRsp 网关认证应答 */
    export interface GateAuthRsp{
        /**  错误码 */
        err_code? : gate.ErrCode;
    }

    /** GateHeartBeatReq 心跳检测请求 */
    export interface GateHeartBeatReq{
        /**  时间 */
        time_stamp? : number;
    }

    /** GateHeartBeatRsp 心跳检测应答 */
    export interface GateHeartBeatRsp{
        /**  时间 */
        time_stamp? : number;
    }

    /** GateAnotherLoginNtf 顶号通知 */
    export interface GateAnotherLoginNtf{
        /**  保留 */
        reserve? : number;
        /**  顶号设备 */
        device? : string;
    ...
    /** GateNoLoginNtf 未登陆通知 */
    export interface GateNoLoginNtf{
        /**  保留 */
        reserve? : number;
    }

    /** GateTransmitHTTPReq 向平台服转发 HTTP 请求 */
    export interface GateTransmitHTTPReq{
    ...
    /** GateTransmitHTTPRsp HTTP 响应 */
    export interface GateTransmitHTTPRsp{
        /**  e.g 200 */
        status_code? : number;
        /**  响应数据 */
    ...
    /** GateRegisterReq 注册请求 */
    export interface GateRegisterReq{
        /**  手机号 */
        phone? : string;
        /**  密码 */
        password? : string;
    ...
    /** GateRegisterRsp 注册响应 */
    export interface GateRegisterRsp{
        /**  错误码 */
        err_code? : gate.ErrCode;
        /**  错误内容 */
        err_msg? : string;
    ...
    /** GateResetPasswordReq 找回密码请求 */
    export interface GateResetPasswordReq{
        /**  手机号 */
        phone? : string;
        /**  新密码 */
        password? : string;
    ...
    /** GateResetPasswordRsp 找回密码响应 */
    export interface GateResetPasswordRsp{
        /**  错误码 */
        err_code? : gate.ErrCode;
        /**  错误内容 */
        err_msg? : string;
    ...
    /** GateSendSmsCodeReq 发送短信验证码请求 */
    export interface GateSendSmsCodeReq{
        /**  手机号 */
        phone? : string;
    ...
    /** GateSendSmsCodeRsp 发送短信验证码响应 */
    export interface GateSendSmsCodeRsp{
        /**  错误码 */
        err_code? : gate.ErrCode;
        /**  错误内容 */
        err_msg? : string;
    ...
    /** GateGetPicCodeReq 获取图形验证码请求 */
    export interface GateGetPicCodeReq{
        /**  手机号 */
        phone? : string;
    }

    /** GateGetPicCodeRsp 获取图形验证码响应 */
    export interface GateGetPicCodeRsp{
        /**  错误码 */
        err_code? : gate.ErrCode;
        /**  图形验证码数据 */
        buf? : string;
    ...
    /** GateTransferMsgFailNtf 转发消息失败通知 */
    export interface GateTransferMsgFailNtf{
        /**  消息ID */
        msg_id? : number;
        /**  失败描述 */
        fail_des? : string;
