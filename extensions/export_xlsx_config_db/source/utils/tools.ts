...
export default class Tools {
     ...
     * ]
     */
    static loadRawDatasFromXlsx(filePath : string) : {name : string,data : string[][]}[] {
        let sheets = xlsx.parse(filePath);

        let rawDatas : {name : string,data : string[][]}[] = [];
    ...
    static loadRawDatasFromXlsxAsync(filePath : string, cb : (rawDatas : {name : string,data : string[][]}[])=>void) {
     ...
     * @param name 
     */
    public static upperFirstLetter(name : string){
