declare namespace game{
    ...
    interface SUDDeskInfo{
        ...
        /** 前三名下注人员信息 */
        player_rank_ntf? : baccarat.RankInfo;
        /** 下注信息 */
    ...
    /** 阶段 */
    interface SUDSevenUpDownBetNtf{
        /**  桌子ID */
        desk_id? : number;
        /**  下注玩家信息 */
        players : BetPlayer[];
    ...
    /** 阶段 */
    interface SUDSevenUpDownWinType{
        /** 开奖结果列表 */
        win_type : number[];
        /** 是否翻倍 */
        is_double? : boolean;
    ...
    /** EnterBaccaratReq 进入7UPDOWN请求 */
    interface MsgEnterSevenUpDownReq{
        /**  主题ID */
        theme_id? : number;
        /**  是否是换桌 */
        change? : boolean;
    ...
    /** EnterBaccaratRsp 进入7UPDOWN请求响应 */
    interface MsgEnterSevenUpDownRsp{
        /**  请求结果信息 */
    ...
    /** LeaveBaccaratReq 离开7UPDOWN请求 */
    interface MsgLeaveSevenUpDownReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** LeaveBaccaratRsp 离开7UPDOWN请求响应 */
    interface MsgLeaveSevenUpDownRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
    }

    /** 7UPDOWN 历史中奖请求请求 */
    interface MsgGetPercentReq{
        /**  桌子ID */
        desk_id? : number;
    }

    /** 7UPDOWN 历史中奖请求响应 */
    interface MsgGetPercentRsp{
        /** 中奖概率 */
        percents : number[];
    }

    /** BetBaccaratReq 7UPDOWN下注请求 */
    interface MsgBetSevenUpDownReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** BetBaccaratRsp 7UPDOWN下注请求响应 */
    interface MsgBetSevenUpDownRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  扣除金币 */
        cost_coin? : string;
    ...
    /** 取消下注请求 */
    interface MsgCancelBetSevenUpDownReq{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** 取消下注请求响应 */
    interface MsgCancelBetSevenUpDownRsp{
        /**  请求结果信息 */
        result? : commonrummy.RummyResult;
        /**  扣除金币 */
        cost_coin? : string;
    ...
    /** 取消下注请求响应通知 */
    interface MsgCancelBetBaccaratNtf{
        /**  主题ID */
        theme_id? : number;
        /**  桌子ID */
        desk_id? : number;
    ...
    /** BetBaccaratNtf 最新玩家下注通知消息 */
    interface SevenUpDownPlayerHistory{
        /**  期数 */
        period? : string;
        /**  下注金额 */
        bet? : string;
