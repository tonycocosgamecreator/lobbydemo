declare namespace hallrummy{

    const PACKAGE_NAME = 'hall';
    ...
    /** RummyGetPlayerInfoReq rummy点击玩家头像，获取玩家信息请求 */
    interface RummyGetPlayerInfoReq{
    }

    /** RummyGetPlayerInfoRsp rummy点击玩家头像，获取玩家信息回复 */
    interface RummyGetPlayerInfoRsp{
        /** 请求结果信息 */
