declare namespace msgserver{

    const PACKAGE_NAME = 'msgserver';
    ...
    /** 获取公告列表请求 */
    interface MsgSvrGetNoticeListReq{
        /**  玩家ID */
        player_id? : number;
        /**  类型 0 默认 1 大转盘 */
        type? : number;
    ...
    /** 获取公告列表请求应答 */
    interface MsgSvrGetNoticeListRsp{
    ...
    /** 获取跑马灯请求 */
    interface MsgSvrGetHorseRaceReq{
        /**  玩家ID */
        player_id? : number;
        /**  类型 0 默认 1 大转盘 */
        type? : number;
    ...
    /** 获取跑马灯应答 */
    interface MsgSvrGetHorseRaceRsp{
        /**  错误码， 参考 common.ErrCode */
        err_code? : number;
        /**  错误描述 */
        err_desc? : string;
    ...
    /** 跑马灯变化通知 */
    interface MsgSvrHorseRaceUpdateNtf{
        /**  渠道Id */
        channel? : number;
        /**  新加的跑马灯内容 */
        content? : string;
    ...
    /** msgid:MsgSvrHorseRaceJbrNtf = 0x4010; // 跑马灯假百人变化通知 */
    interface MsgSvrHorseRaceJbrNtf{
        /**  玩家名称 */
        name? : string;
        /**  玩家头像 */
        icon? : string;
    ...
    /** msgid: MSGSVR_VOICE_STATE_CHANGE_NTF = 0x400D;       //语聊玩家状态变化通知消息 */
    interface MsgSvrVoiceStateChangeNtf{
        /**  变化的玩家信息 */
        change_player? : VoicePlayerInfo;
    }

    /** 进入语聊房间请求 */
    interface MsgSvrEnterVoiceRoomReq{
        /**  玩家ID */
        player_id? : number;
        /**  当前状态 */
        state_id? : number;
    ...
    /** 进入语聊房间应答 */
    interface MsgSvrEnterVoiceRoomRsp{
        /**  错误码， 参考 common.ErrCode */
        err_code? : number;
        /**  错误描述 */
        err_desc? : string;
    ...
    /** 离开语聊房间请求 */
    interface MsgSvrLeaveVoiceRoomReq{
        /**  玩家ID */
        player_id? : number;
    }

    /** 离开语聊房间应答 */
    interface MsgSvrLeaveVoiceRoomRsp{
        /**  错误码， 参考 common.ErrCode */
        err_code? : number;
        /**  错误描述 */
        err_desc? : string;
    ...
    /** 获取语聊玩家信息请求 */
    interface MsgSvrGetVoicePlayerInfoReq{
        /**  微信openid */
        open_id : string[];
    }

    /** 获取语聊玩家信息应答 */
    interface MsgSvrGetVoicePlayerInfoRsp{
        /**  错误码， 参考 common.ErrCode */
        err_code? : number;
        /**  错误描述 */
        err_desc? : string;
