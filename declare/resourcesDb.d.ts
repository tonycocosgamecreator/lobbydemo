...
declare module resourcesDb {
    ...
    export const PANEL_RESOURCES_STATISTICAL_DB_VIEWNAME: {
        ...
        ['CustomButtomRank']: 'CustomButtomRank',
        ['CustomButtomUserBets']: 'CustomButtomUserBets',
        ...
        ['CustomRoulettePointer']: 'CustomRoulettePointer',
        ['CustomRouletteResult']: 'CustomRouletteResult',
